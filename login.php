        ...
        <div class="col-lg-8 my-3">
            ...
            <div class="row">
                ...
                <div class="col-lg my-3">
                    ...
                    <form action="/phpStudy/src/controllers/cadastro.php" method="POST" class="my-3 form-cadastro">
                ...
                <div class="col-lg my-3">
                    ...
                    <form action="/phpStudy/src/controllers/login.php" method="POST" class="form-login">
                        <div class="form-group">
                          <label>Endereço de Email</label>
                          <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Insira o email" name="email">
                        </div>
